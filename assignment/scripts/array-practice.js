...
favoriteFoods.push('gummy bears');
...
console.log(`Added another food to the beggining: ${favoriteFoods}.`);
...
favoriteFoods[1] = 'chicken wings';
console.log('I changed the 2nd food on my list', favoriteFoods);
